...
export default class GlobalViewE extends Component {
    ...
    getData()
      .then((resp) => {
        ...
        data.forEach((element) => {
          ...
          compState.global.recovered.totalRecovered = parseInt(
        ...
        .then((resp) => {
          ...
          switch (i) {
            case 0:
              ...
              completeState.continent.australia.totalRecovered =
                total_Recovered;
            ...
            case 1:
              ...
              completeState.continent.southAmerica.totalRecovered =
                total_Recovered;
              // console.log(
              //   "southAmerica",
            ...
            case 2:
              ...
              completeState.continent.northAmerica.totalRecovered =
                total_Recovered;
              // console.log(
              //   "northAmerica",
  ...
  handleRegionButttonClick = (region) => {
    // console.log(region);
    const compStateInHandleRC = { ...this.state };
    compStateInHandleRC.selectedView = region;
    this.setState(compStateInHandleRC);
    // console.log("clicked region change: ", this.state.selectedView); // experiancing delay in updating state value
  };
    ...
    return (
      <div className="globalView-body">
        <MainGrid
          ...
          regionData={this.state.continent}
        />
      </div>
    );
  }
